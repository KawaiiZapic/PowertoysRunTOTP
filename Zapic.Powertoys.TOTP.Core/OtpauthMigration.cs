...
namespace Zapic.PowerToys.TOTP.Core
{
    ...
    public static partial class IReflection
    {
        ...
        static IReflection()
        {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Zapic.PowerToys.TOTP.Core.Payload), global::Zapic.PowerToys.TOTP.Core.Payload.Parser, new[]{ "OtpParameters", "Version", "BatchSize", "BatchIndex", "BatchId" }, null, new[]{ typeof(global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm), typeof(global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount), typeof(global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType) }, null, new pbr::GeneratedClrTypeInfo[] { new pbr::GeneratedClrTypeInfo(typeof(global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters), global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters.Parser, new[]{ "Secret", "Name", "Issuer", "Algorithm", "Digits", "Type", "Counter" }, null, null, null, null)})
                }));
        }
        #endregion
...
#endif
    {
        ...
        {
            get { return global::Zapic.PowerToys.TOTP.Core.IReflection.Descriptor.MessageTypes[0]; }
        }
        ...
        private static readonly pb::FieldCodec<global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters> _repeated_otpParameters_codec
            = pb::FieldCodec.ForMessage(10, global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters.Parser);
        private readonly pbc::RepeatedField<global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters> otpParameters_ = new pbc::RepeatedField<global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters>();
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
        [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
        public pbc::RepeatedField<global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpParameters> OtpParameters
        {
      ...
      while ((tag = input.ReadTag()) != 0) {
        ...
        public static partial class Types
        {
...
#endif
            {
                ...
                public static pbr::MessageDescriptor Descriptor
                {
                    get { return global::Zapic.PowerToys.TOTP.Core.Payload.Descriptor.NestedTypes[0]; }
                }
                ...
                private global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm algorithm_ = global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm.Unspecified;
                [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
                [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
                public global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm Algorithm
                {
                ...
                private global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount digits_ = global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount.Unspecified;
                [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
                [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
                public global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount Digits
                {
                    get { return digits_; }
                    set
                    {
                ...
                private global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType type_ = global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType.Unspecified;
                [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
                [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
                public global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType Type
                {
                    get { return type_; }
                    set
                    {
                ...
                public override int GetHashCode()
                {
                    ...
                    if (Algorithm != global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm.Unspecified) hash ^= Algorithm.GetHashCode();
                    if (Digits != global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount.Unspecified) hash ^= Digits.GetHashCode();
                    if (Type != global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType.Unspecified) hash ^= Type.GetHashCode();
          ...
          if (_unknownFields != null) {
            _unknownFields.WriteTo(output);
                ...
                void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output)
                {
                    ...
                    if (Algorithm != global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm.Unspecified)
                    {
                        output.WriteRawTag(32);
                        output.WriteEnum((int)Algorithm);
                    }
                    if (Digits != global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount.Unspecified)
                    {
                        output.WriteRawTag(40);
                        output.WriteEnum((int)Digits);
                    }
                    if (Type != global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType.Unspecified)
                    {
                        output.WriteRawTag(48);
                        output.WriteEnum((int)Type);
                    }
                ...
                public void MergeFrom(OtpParameters other)
                {
                    ...
                    if (other.Algorithm != global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm.Unspecified)
                    {
                        Algorithm = other.Algorithm;
                    }
                    if (other.Digits != global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount.Unspecified)
                    {
                        Digits = other.Digits;
                    }
                    if (other.Type != global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType.Unspecified)
                    {
                        Type = other.Type;
                    }
                    if (other.Counter != 0L)
                ...
                void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input)
                {
                    ...
                    while ((tag = input.ReadTag()) != 0)
                    {
                        switch (tag)
                        {
                            ...
                            case 32:
                                {
                                    Algorithm = (global::Zapic.PowerToys.TOTP.Core.Payload.Types.Algorithm)input.ReadEnum();
                                    break;
                                }
                            case 40:
                                {
                                    Digits = (global::Zapic.PowerToys.TOTP.Core.Payload.Types.DigitCount)input.ReadEnum();
                                    break;
                                }
                            case 48:
                                {
                                    Type = (global::Zapic.PowerToys.TOTP.Core.Payload.Types.OtpType)input.ReadEnum();
                                    break;
                                }
                            case 56:
                                {
